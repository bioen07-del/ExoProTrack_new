...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      lyophilization_event: {
        Row: {
          completed_at: string | null
          created_at: string | null
          duration_hours: number | null
          freezing_temp_c: number | null
          lyophilization_id: string
          notes: string | null
          pack_lot_id: string
          performed_by: string | null
          primary_drying_pressure_mbar: number | null
          primary_drying_temp_c: number | null
          program_name: string | null
          secondary_drying_temp_c: number | null
      ...
      pack_lot: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_pack_lot_pack_format"
            columns: ["pack_format_code"]
            isOneToOne: false
            referencedRelation: "pack_format"
            referencedColumns: ["pack_format_code"]
          },
          {
            foreignKeyName: "fk_pack_lot_request_line"
            columns: ["request_line_id"]
            isOneToOne: false
            referencedRelation: "request_line"
            referencedColumns: ["request_line_id"]
          ...
          {
            foreignKeyName: "fk_pack_lot_source_cm_lot"
            columns: ["source_cm_lot_id"]
            isOneToOne: false
      ...
      pack_processing_step: {
        ...
        Relationships: [
          {
            foreignKeyName: "pack_processing_step_pack_lot_id_fkey"
            columns: ["pack_lot_id"]
            isOneToOne: false
            referencedRelation: "pack_lot"
            referencedColumns: ["pack_lot_id"]
          },
          {
            foreignKeyName: "pack_processing_step_performed_by_fkey"
