...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for qc-protocols" ON storage.objects FOR SELECT USING (bucket_id = 'qc-protocols');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for qc-protocols" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'qc-protocols');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for qc-protocols" ON storage.objects FOR UPDATE USING (bucket_id = 'qc-protocols');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for qc-protocols" ON storage.objects FOR DELETE USING (bucket_id = 'qc-protocols');`
    ];
