...
-- Created at: 1768847040

-- Расширение таблицы request для резервации и требований
ALTER TABLE request 
ADD COLUMN IF NOT EXISTS reserved_cm_lot_id UUID REFERENCES cm_lot(cm_lot_id),
ADD COLUMN IF NOT EXISTS product_id UUID REFERENCES product(product_id),
