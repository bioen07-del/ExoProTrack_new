...
-- Версия: 3.4.0 (исправленная)
-- Дата: 2026-01-24
-- Безопасна для повторного применения (IF NOT EXISTS, OR REPLACE, DROP IF EXISTS)
...
-- RLS через app_user.auth_user_id (не auth.uid() напрямую)
